...
import { dislikePost } from "../../controllers/post.controller.js";
...
describe('dislikePost() dislikePost method', () => {
    ...
    describe('Happy paths', () => {
        ...
        it('should emit a notification if the post author is not the disliking user', async () => {
            await dislikePost(req, res);
